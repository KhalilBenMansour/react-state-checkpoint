...
class App extends Component {
  state = {
    Person: {
      ...
      Bio: "Civil Engineer Who Has Maked A Retraining To Web Developement",
  ...
  render() {
    ...
    return (
      <div className="App">
        {showInfo}
        <button onClick={this.toggleClick}>Show/Hide Info</button>
        <div>Time:{this.state.count} second</div>
      </div>
    );
  }
  componentDidMount() {
